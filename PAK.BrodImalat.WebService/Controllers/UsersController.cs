...
//using PAK.BrodImalat.WebService.MBefore;
...
//        public UsersController(AppIdenittyDbContext context)
//        {
//            _context = context;
//        }
...
//            var result = _context.users.FirstOrDefault(p => p.Email == userLogin.Email && p.Password == userLogin.Password && p.Active==true);
